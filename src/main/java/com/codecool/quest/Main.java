...
public class Main extends Application {
    ...
    public void setEndGameScene(String whichMap){
        this.map = MapLoader.loadMap(whichMap);
        String whichScene = "endScene";
        setScene(whichScene);
        setPrimaryScene(this.primaryStage, whichScene);
        refresh();
    }
    ...
    private void setScene(String whichScene) {
        ...
        /*
        Create User Interface on the right side and set them width and padding
         */
        ...
        ui.add(new Label("Codecooler"), 0, 1);
...
//        ui.add(battleLog, 0, 15);
        ...
        /*
        Add elements to the center panel
         */

        borderPane.setCenter(canvas);
        //Depending on the which scene we want to load UI will be add to the scene
        if (whichScene.equals("gameScene")) {
